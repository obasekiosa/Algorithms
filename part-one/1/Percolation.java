...
public class Percolation {
    ...
    public void open(int row, int col) {
        ...
        if (right <= this.grid.length && isOpen(row, right)) {
            this.bottomConnected[this.uf.find(index(row, col))] |= this.bottomConnected[this.uf
                    .find(index(row, right))];
            this.bottomConnected[this.uf.find(index(row, right))] |= this.bottomConnected[this.uf
                    .find(index(row, col))];
        ...
        if (bottom <= this.grid.length && isOpen(bottom, col)) {
            this.bottomConnected[this.uf.find(index(row, col))] |= this.bottomConnected[this.uf
                    .find(index(bottom, col))];
            this.bottomConnected[this.uf.find(index(bottom, col))] |= this.bottomConnected[this.uf
                    .find(index(row, col))];
